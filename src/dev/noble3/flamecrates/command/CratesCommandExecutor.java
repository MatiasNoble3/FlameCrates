...
public class CratesCommandExecutor implements CommandExecutor {
    ...
    public CratesCommandExecutor(final CrateManager crateManager, final CratesPlayerManager cratesPlayerManager,
        ...
        addDefaultCommands(crateManager, cratesPlayerManager, server);
    }

    private void addDefaultCommands(final CrateManager crateManager, final CratesPlayerManager cratesPlayerManager,
                                    final Server server) {
